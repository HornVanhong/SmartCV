...
const MailIcon = ({ color }: { color: string }) => (
  <Svg viewBox="0 0 24 24" style={{ width: 7.5, height: 7.5, marginRight: 4 }}>
    <Path
          ...
          <View style={[styles.sidebarSection, { marginBottom: 10 }]}>
            ...
            {personalInfo.email ? (
              <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 3.5 }}>
                ...
                <Link src={`mailto:${personalInfo.email}`} style={[styles.sidebarContactLink, { color: isLight ? primaryColor : "#ffffff", marginBottom: 0 }]}>
                  <Text>{personalInfo.email}</Text>
                </Link>
              </View>
            ) : null}
            {personalInfo.phone ? (
              <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 3.5 }}>
                ...
                <Text style={[styles.sidebarContactText, { color: textBodyColor, marginBottom: 0 }]}>{personalInfo.phone}</Text>
              </View>
            ) : null}
            {personalInfo.location ? (
              <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 3.5 }}>
                <MapPinIcon color={isLight ? "#94a3b8" : "rgba(255, 255, 255, 0.55)"} />
                <Text style={[styles.sidebarContactText, { color: textBodyColor, marginBottom: 0 }]}>{personalInfo.location}</Text>
              </View>
            ) : null}
          </View>
          ...
          <View style={[styles.sidebarSection, { marginBottom: 10 }]}>
            ...
            {personalInfo.portfolio ? (
              <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 3.5 }}>
                ...
                <Link src={formatUrl(personalInfo.portfolio)} style={[styles.sidebarContactLink, { color: isLight ? primaryColor : "#ffffff", marginBottom: 0 }]}>
                  <Text>{cleanLink(personalInfo.portfolio)}</Text>
                </Link>
              </View>
            ) : null}
            {personalInfo.github ? (
              <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 3.5 }}>
                ...
                <Link src={formatUrl(personalInfo.github)} style={[styles.sidebarContactLink, { color: isLight ? primaryColor : "#ffffff", marginBottom: 0 }]}>
                  <Text>{cleanLink(personalInfo.github)}</Text>
                </Link>
              </View>
            ) : null}
            {personalInfo.linkedin ? (
              <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 3.5 }}>
                ...
                <Link src={formatUrl(personalInfo.linkedin)} style={[styles.sidebarContactLink, { color: isLight ? primaryColor : "#ffffff", marginBottom: 0 }]}>
                  <Text>{cleanLink(personalInfo.linkedin)}</Text>
                </Link>
              </View>
            ) : null}
          </View>
